...
name_label = Label(window, text='Name: ', font=('Courier', 14), justify=CENTER)
email_label = Label(window, text='ID: ', font=('Courier', 14), justify=CENTER)
pass_label = Label(window, text='Password: ', font=('Courier', 14), justify=CENTER)
name = Entry(window, font=('Courier', 14), justify=CENTER)
email = Entry(window, font=('Courier', 14), justify=CENTER)
password = Entry(window, show='*', font=('Courier', 14), justify=CENTER)
submit = Button(window, text='Add ID', command=onsubmit, font=('Courier', 14))
...
name.grid(columnspan=2, row=1, column=1, padx=2, pady=2, sticky=W)
...
name_label2 = Label(window, text='Name: ', font=('Courier', 14), justify=CENTER)
email_label2 = Label(window, text='ID: ', font=('Courier', 14), justify=CENTER)
pass_label2 = Label(window, text='Password: ', font=('Courier', 14), justify=CENTER)

name_label2.grid(row=5)
email_label2.grid(row=5, column=1, padx=200)
pass_label2.grid(row=5, column=2, padx=10)
